...
public class RandomNoiseTextureControl : Control
{
    ...
    private class NoiseTextureCustomDrawOp(double opacity) : ICustomDrawOperation
    {
        ...
        private SKImage _texture = CreateNoiseImage(DesiredWidth, DesiredHeight);
        ...
        public void Render(ImmediateDrawingContext context)
        {
            ...
            blendPaint.FilterQuality = SKFilterQuality.High;
    ...
    public override void Render(DrawingContext context)
    {
        ...
        if (!IsEffectivelyVisible || Opacity == 0 || !IsVisible) return;
